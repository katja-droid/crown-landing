...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 2413;
        $headers['auth']['clientCompany'] = "UpiBzLsTsVY637wvoHfm";
        $headers['auth']['clientSecret'] = "MjQxM1VwaUJ6THNUc1ZZNjM3d3ZvSGZtY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
